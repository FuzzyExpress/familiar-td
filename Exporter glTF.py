...
# Objects must be shown to be exported
# Store visibility and objects and show them

# For collections
for c in bpy.data.collections:
    vC.append((c.hide_viewport, c))
    c.hide_viewport = False

# For objects
for o in bpy.data.objects:
    vO.append((o.hide_viewport, o))
    o.hide_viewport = False

# Run glTF exports for each collection
for c in bpy.data.collections:
    print(c.name)

    bpy.ops.export_scene.gltf(
            filepath=f"/home/evans/GitProjects/familiar-td/Objects/{c.name}.glb",
...
# Restore visibility
for c in vC:
    c[1].hide_viewport = c[0]

for o in vO:
    o[1].hide_viewport = o[0]